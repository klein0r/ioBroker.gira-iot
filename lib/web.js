...
function GiraWebExtension(server, webSettings, adapter, instanceSettings, app) {
    ...
    (function __constructor() {
        if (!that.settings.secure) {
        ...
        } else if (that.config.ipInterface === '0.0.0.0') {
            ...
            that.adapter.sendTo(that.namespace, 'registerCallbacks', { baseUrl: `https://${that.config.ipInterface}:${that.settings.port}/${that.namespace}` });
